...
<div class="container mx-auto p-6">
    <div class="bg-white rounded-lg shadow-lg overflow-hidden relative">
        ...
        <div class="relative">
            ...
            <!-- Tombol Kiri -->
            <button class="absolute top-1/2 -translate-y-1/2 left-4 bg-gray-500 text-white font-bold py-2 px-3 rounded-lg hover:bg-gray-600">
                &lt;
            </button>
            <!-- Tombol Kanan -->
            <button class="absolute top-1/2 -translate-y-1/2 right-4 bg-gray-500 text-white font-bold py-2 px-3 rounded-lg hover:bg-gray-600">
                &gt;
            </button>
        </div>
