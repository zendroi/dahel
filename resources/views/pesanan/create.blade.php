    ...
    <div class="flex justify-center items-center min-h-screen">
        <form action="{{ route('pesanan.store') }}" method="POST">
            ...
            <div class="relative max-w-4xl w-full bg-white rounded-lg shadow-lg p-8">
                ...
                <form method="POST" action="{{ route('store') }}" class="mt-6">
                    <!-- CSRF Token -->
                    @csrf

                    <!-- Participant Count -->
                    <div class="mt-6">
                        <label for="jumlahpeserta" class="block text-gray-700 text-lg">Jumlah Peserta</label>
                        <div class="flex items-center mt-2">
                            <button type="button" onclick="decreaseValue()"
                                class="border border-gray-300 px-3 py-1 text-lg">-</button>
                            <input id="jumlahpeserta" name="jumlahpeserta" type="number"
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="col-md">
                                        <div class="form-floating">
                                            ...
                                            <label for="floatingSelectGrid">kode negara</label>
                                        </div>
                                    </div>
                                </div>
